...
files=['test_upg_analyzer.py','test_recovery_state.py','test_official_package_local.py','test_original_updater_controlflow.py','test_win7_compat.py','test_rescue_fat.py','test_v07_recovery_ladder.py','test_v08_vendor_probes.py']
failed=0; total=0
for fn in files:
 p=root/fn
