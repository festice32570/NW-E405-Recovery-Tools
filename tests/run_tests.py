...
files=['test_upg_analyzer.py','test_recovery_state.py','test_official_package_local.py','test_original_updater_controlflow.py','test_win7_compat.py','test_rescue_fat.py']
failed=0; total=0
for fn in files:
 p=root/fn
